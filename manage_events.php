        ...
        <div class="card mrg_bottom">
              ...
              <div class="search_list">
                <div class="search_block">
                  <form  method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <input class="form-control input-sm" placeholder="Search..." aria-controls="DataTables_Table_0" type="search" name="search_value" value="<?=(isset($_POST['search_value'])) ? $_POST['search_value'] : '';?>" required>
                    <button type="submit" name="event_search" class="btn-search"><i class="fa fa-search"></i></button>
                  </form>  
                </div>
                <div class="add_btn_primary"> <a href="add_event.php">Add Event</a> </div>
              </div>
            </div>
          ...
          <div role="tabpanel" class="card-body mrg_bottom" style="padding: 0px">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="manage_events.php" aria-controls="home" aria-expanded="true">Admin Events</a></li>
                <li role="presentation"><a href="user_events.php" aria-controls="profile" aria-expanded="false">Users Events</a></li>
            </ul>
          </div>
              ...
              <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="block_wallpaper">
                  ...
                  <div class="wall_image_title">
                      ...
                      <span>
                        <strong style="font-weight: 500">Created By: Admin</strong> 
                      </span>
                     ...
                     <ul>
                      ...
                      <li><a href="edit_event.php?event_id=<?php echo $event_row['id'];?>&redirect=<?=$redirectUrl?>" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a></li>
