          ...
          <tbody>
            <?php           
              ...
              <tr <?php if($users_row['is_duplicate']==1){ echo 'style="background-color: rgba(255,0,0,0.1);"'; } ?>>
                ...
                <td><a href="edit_user_profile.php?user_id=<?= $users_row['id'] ?>">
                ...
                <td>
                 <a href="edit_user_profile.php?user_id=<?=$users_row['id']?>" data-id="<?php echo $users_row['id'];?>" class="btn btn-success btn_edit" data-toggle="tooltip" data-tooltip="Profile"><i class=" fa fa-history"></i></a>
